class Field {
    ...
    plant(x, y) {
        ...
        if(cropName[0] == 'Wheat'){
            this._crops.push(new Wheat(cropName[0], this, x, y))
        } else if(cropName[0] == 'Pumpkin') {
            this._crops.push(new Pumpkin(cropName[0], this, x, y))
        } else if(cropName[0] == 'Carrot') {
            this._crops.push(new Carrot(cropName[0], this, x, y))
        } else {
